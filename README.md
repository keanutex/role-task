...
Matcher Service - this matches users to roles and calculates the user's total score for each role.  The score is calculated using the average of the users skill scores for each skill contained in the Role Skill Profile.

## Your task
Complete the method MatcherService->matchAll()
In completing this, the unit tests should pass.

## Running the assigmment
